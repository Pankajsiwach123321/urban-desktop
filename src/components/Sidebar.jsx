    ...
    <div>
      ...
      >
        <div>
          ...
          <p className=" hidden lg:block text-base font-bold font-Inter bg-browngradiant bg-clip-text text-transparent text-center pt-5">
            URBAN NFT
          </p>
        </div>
        <div className="flex flex-col justify-between overflow-y-scroll  h-full mt-[68px]">
          ...
          <div>
            <h2 className="text-black hidden lg:block text-xs font-medium font-Inter lg:ps-[14px]">
              MY PROFILE
            </h2>
            <div>
              <Link
              ...
              <div className="links-aside rounded-3xl p-[14px] w-full hover:bg-brownlightgr mt-[11px] lg:flex items-center gap-4 group duration-300 cursor-pointer">
                <svg
                  width="12"
                  height="16"
                  viewBox="0 0 12 16"
          ...
          <div className=" links-aside rounded-3xl p-[14px] w-full hover:bg-brownlightgr lg:flex items-center gap-4 group duration-300 cursor-pointer">
            <svg
              width="16"
              height="16"
              viewBox="0 0 16 16"
